...
- transcode.py : Transcode files in the current working directory and save new files to a new directory.
...
While transcoding a large amount of files with transcode.py use the --enable-log flag to log what files were successfully transcoded.
In case of a crash/disconnect use "file_remover.py /home/user/scripts/transcode.log -k" to remove corrupted files and run transcode.py again to resume
transcoding.
